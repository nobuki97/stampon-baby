    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 bg-green-50 rounded-2xl p-4 border border-green-100">
        ...
        <button onClick={() => setGuideOpen(v => !v)}
          className="w-full py-3 rounded-full border-2 border-green-300 text-green-600 font-bold text-sm hover:bg-green-100 transition-colors">
          ...
          <div className="flex flex-col gap-4 bg-white rounded-2xl p-4 border border-green-200 text-xs text-gray-600 leading-relaxed">
            <div>
              ...
              <ol className="flex flex-col gap-1 list-decimal list-inside">
                ...
                <li>「LINEスタンプメーカー」アプリをインストール</li>
                <li>アプリを開いて「スタンプを作成」をタップ</li>
                <li>16枚の画像を1枚ずつ登録する</li>
                <li>販売情報で「無料ダウンロード・売上分配なし」を選択</li>
                <li>「販売申請」をタップして審査に提出</li>
            ...
            <div>
              ...
              <ol className="flex flex-col gap-1 list-decimal list-inside">
                ...
                <li>アプリを開いて「スタンプを作成」をタップ</li>
                <li>16枚の画像を1枚ずつ登録する</li>
                <li>販売情報で「有料ダウンロード・売上分配あり」を選択</li>
                <li>価格（120円〜）を設定する</li>
                <li>「販売申請」をタップして審査に提出</li>

...
export async function POST(req: NextRequest) {
  try {
      ...
      line_items: [
        {
          price_data: {
            currency: 'jpy',
            product_data: {
              name: 'STAMPON - 繝壹ャ繝・INE繧ｹ繧ｿ繝ｳ繝嶺ｽ懈・',
              description: '諢帙☆繧九・繝・ヨ縺ｮ繧ｪ繝ｪ繧ｸ繝翫ΝLINE繧ｹ繧ｿ繝ｳ繝・6譫壹そ繝・ヨ',
            },
            unit_amount: 480,
          },
          quantity: 1,
    ...
    return new Response(
      JSON.stringify({ error: '豎ｺ貂医・貅門ｙ縺ｫ螟ｱ謨励＠縺ｾ縺励◆縲ゅ＠縺ｰ繧峨￥縺励※縺九ｉ縺願ｩｦ縺励￥縺縺輔＞縲・ }),
